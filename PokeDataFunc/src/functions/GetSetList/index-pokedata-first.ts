...
export async function getSetListPokeDataFirst(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
    ...
    try {
        ...
        const errorResponse = handleError(error, "GetSetListPokeDataFirst");
        return {
            jsonBody: errorResponse,
