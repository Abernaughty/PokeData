...
async function refreshData(myTimer) {
    ...
    try {
        ...
        const apiSets = await index_1.pokemonTcgApiService.getAllSets();
        ...
        const dbSets = await index_1.cosmosDbService.getAllSets();
        ...
        if (apiSets.length > 0) {
            await index_1.cosmosDbService.saveSets(apiSets);
