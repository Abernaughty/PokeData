...
const PokeDataToTcgMappingService_1 = require("../../services/PokeDataToTcgMappingService");
const PokemonTcgApiService_1 = require("../../services/PokemonTcgApiService");
const ImageEnhancementService_1 = require("../../services/ImageEnhancementService");
// Initialize services for PokeData-first architecture
const pokemonTcgApiService = new PokemonTcgApiService_1.PokemonTcgApiService(process.env.POKEMON_TCG_API_KEY || '');
const imageEnhancementService = new ImageEnhancementService_1.ImageEnhancementService(PokeDataToTcgMappingService_1.pokeDataToTcgMappingService, pokemonTcgApiService);
/**
...
async function getCardInfo(request, context) {
    ...
    try {
        ...
        if (!pokeDataCardId) {
            ...
            const errorResponse = (0, errorUtils_1.createNotFoundError)("PokeData Card ID", "missing", "GetCardInfo");
            return {
        ...
        if (!card) {
            ...
            try {
                ...
                const errorResponse = (0, errorUtils_1.handleError)(error, "GetCardInfo - PokeData API");
                return {
                    jsonBody: errorResponse,
                    status: errorResponse.status
                };
        ...
        const errorResponse = (0, errorUtils_1.handleError)(error, "GetCardInfo - PokeData-First");
        return {
            jsonBody: errorResponse,
            status: errorResponse.status
        };
